...
usage = "Usage: {0} <ConversionStats.xml>".format(sys.argv[0])
...
for s in sample_list:
    ...
    for c in root.findall("./Flowcell/Project/*[@name='"+s+"']/Barcode/Lane/Tile/Pf/ClusterCount"):
...
# Return Table
count_list['UNDETERMINED']=count_list['unknown']
#count_list.remove('unknown')
sample_list.remove('unknown')
